...
export default function MessagesPage() {
  ...
  function buildDealRecordHtml(params: { draft: boolean; title: string }) {
    ...
    const dealViewUrl = activeConversationId
      ? `/messages?conversation=${encodeURIComponent(String(activeConversationId))}`
      : null;
        ...
        <body>
          <div class="wrap">
            ...
            <div class="footer">
              ...
              ${dealViewUrl ? `<div style="margin-top: 8px;">View deal in CardCat: <a href="${escapeHtml(dealViewUrl)}" target="_blank" rel="noreferrer">Open Messages</a></div>` : ""}
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[360px_minmax(0,1fr)]">
          <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-4 flex flex-col h-[calc(100vh-220px)] overflow-hidden">
            ...
            <details className="mt-6 border-t border-white/10 pt-4">
	          ...
	          <div className="mt-4 min-h-0 rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.06] p-4 shadow-[0_0_0_1px_rgba(16,185,129,0.18)] max-h-[62vh] overflow-y-auto [-webkit-overflow-scrolling:touch] lg:max-h-none lg:overflow-y-visible">
	                    <div className="flex items-start justify-between gap-3">
	                    <div>
