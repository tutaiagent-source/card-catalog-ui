          ...
          <>
            ...
            <section className="mt-6 lg:hidden">
              <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-4">
	              	...
	              	{listView === "vertical" ? (
	              		<div className="space-y-3" role="list" aria-label="Listed cards">
	              			{sortedCards.map((c) => {
	              				...
	              				return (
	              					<div
	              						...
	              						className={`relative rounded-2xl border p-4 ${
	              							isOnMarket ? "border-emerald-500/60 bg-emerald-500/25" : "border-red-500/60 bg-red-500/20"
	              						}`}
	              					...
	              					>
	              						...
	              						<div className="flex gap-3">
	              							<div
	              								className={`relative h-20 w-14 overflow-hidden rounded-lg bg-slate-950 flex items-center justify-center border ${
	              							...
	              							<div className="min-w-0 flex-1">
	              								<div className="line-clamp-1 text-sm font-semibold leading-tight text-white">{c.player_name}</div>
	                ...
	                <div className={listView === "vertical" ? "hidden" : ""}>
