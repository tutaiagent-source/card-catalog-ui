  ...
  return (
    <div className={["relative overflow-hidden", className ?? ""].join(" ")}> 
      <div
        ...
        style={{
          backgroundImage: [
            "repeating-linear-gradient(90deg, rgba(255,255,255,0.35) 0 1px, transparent 1px 32px)",
            "repeating-linear-gradient(0deg, rgba(255,255,255,0.25) 0 1px, transparent 1px 32px)",
